...
### 2026-06-15 — [feat] จัดรูปแบบหน้าพิมพ์รายละเอียดสินค้า
- **สรุป:** ปรับหน้าพิมพ์รายละเอียดออเดอร์เป็นรูปแบบตาราง A4 ตามภาพอ้างอิง เพิ่มโลโก้แอปมุมซ้ายบน และแสดง `หมายเหตุแอดมิน` จาก `DiscountInfo` เมื่อมีข้อมูล
- **ไฟล์หลัก:** `src/pages/AdminOrders.jsx`, `docs/PROGRESS_LOG.md`
- **ตรวจสอบ:** `ReadLints`, `npm run build`
- **ลบไฟล์ชั่วคราว:** -

### 2026-06-15 — [fix] ปรับสีปุ่มพิมพ์รายละเอียดออเดอร์
- **สรุป:** เปลี่ยนสีปุ่ม `พิมพ์` ใน popup รายละเอียดออเดอร์เป็นสีน้ำเงิน และปุ่ม `ปิด` เป็นสีแดงตาม UX ที่ต้องการ
- **ไฟล์หลัก:** `src/pages/AdminOrders.jsx`, `docs/PROGRESS_LOG.md`
- **ตรวจสอบ:** `ReadLints`
- **ลบไฟล์ชั่วคราว:** -

### 2026-06-15 — [feat] พิมพ์รายละเอียดออเดอร์พร้อมหมายเหตุ
- **สรุป:** เพิ่มปุ่ม `พิมพ์` ใน popup รายละเอียดออเดอร์ของหน้าแอดมิน และดึง `หมายเหตุแอดมิน` จาก `DiscountInfo` ที่บันทึกจากหน้า `สร้างออเดอร์ (แอดมิน)` มาแสดงในรายละเอียดและเอกสารพิมพ์
- **ไฟล์หลัก:** `src/pages/AdminOrders.jsx`, `docs/PROGRESS_LOG.md`
- **ตรวจสอบ:** `ReadLints`, `npm run build`
- **ลบไฟล์ชั่วคราว:** -
- **หมายเหตุ:** รองรับรูปแบบ `DiscountInfo` ที่มีข้อความ `หมายเหตุแอดมิน: ...` คั่นด้วย `|`
